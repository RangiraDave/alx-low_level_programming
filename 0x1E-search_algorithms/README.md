# This directory contains answers to the following tasks about search algorithms
...
0. Linear search
Write a function that searches for a value in an array of integers using the [https://en.wikipedia.org/wiki/Linear_search](Linear search algorithm)
